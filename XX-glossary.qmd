...
glossary = tibble::tribble(
  ...
  "Map layer", "A map layer is a visual representation of geographical information. We distinguish two types: *data-driven* and *auxiliary* map layers. The former requires spatial objects whereas the latter only the geographic information (bounding box and CRS).",
  ...
  "Shape (object)", "'Shape' is a nickname for a spatial data object, an abbreviation from ESRI's 'shapefile'. It is used in `tm_shape()`.",
