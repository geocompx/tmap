...
- Active voice and present tense are preferred (avoid future tense, if possible)
...
The main caption (`fig-cap`) should start with a capital letter and end with a period.
The subcaptions (`fig-subcap`) should start with a lowercase letter and do not end with a period.
