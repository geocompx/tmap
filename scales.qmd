...
<!-- a note about specifying bivariable scale order -->
<!-- https://r-tmap.github.io/tmap/articles/examples_biv_choro -->
...
flipops = tibble::tribble(
  ...
  "-//",       "Flip main diagonal and rows",
  "-\\\\",    "Flip other diagonal and rows"
)
```
  ...
  tm_shape(slo_tavg) +
    tm_raster(col = tm_vars(dimvalues = c("tavg_1", "tavg_7"), multivariate = TRUE),
              ...
              col.scale = tm_scale_bivariate(values = paste0(op, "pinkblue"),
                scale1 = tm_scale_intervals(breaks = c(-8, -4, -1, 1, 4, 8)),
