...
# Scales of map variables {#sec-scales}
...
The `tm_scale()` function automatically sets the scale for the given map variable and the data type (factor, numeric, and integer).
...
- `multivariate`: in case multiple variables are specified, should they serve as facets (FALSE; default) or as a multivariate map variable?
