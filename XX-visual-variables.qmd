...
library(tmap)
library(sf)
slo_regions = read_sf("data/slovenia/slo_regions_2022.gpkg")
...
@fig-mixsymb-1 shows symbols, which sizes are scales based on the `sv` variable and they are colored using the values from `population`.
