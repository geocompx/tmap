...
Map layout relates to all of the visual aspects of the created plot except the visual variables (@sec-visual-variables), legends (@sec-legends), and map components (@sec-attributes-layers).
