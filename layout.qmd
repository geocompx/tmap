...
A lot of map information is expressed by text, including text labels (@sec-text), legend labels, text in map components (@sec-map-components), or the map title (@sec-layout-elements).
