...
tinytable::tt(color_codings_df[, 2:3]) |>
  tinytable::style_tt(i = 1, j = 1, background = "lightblue") |>
  tinytable::style_tt(i = 2, j = 1, background = "darkblue") |>
  tinytable::style_tt(i = 3, j = 1, background = "lightgreen") |>
  tinytable::style_tt(i = 4, j = 1, background = "darkgreen") |>
  tinytable::style_tt(i = 5, j = 1, background = "pink") |>
  tinytable::style_tt(i = 6, j = 1, background = "red") |>
  tinytable::style_tt(i = 7, j = 1, background = "orange") |>
  tinytable::style_tt(i = 8, j = 1, background = "yellow")
```
