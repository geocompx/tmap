...
#                           output_dir = tempdir())
# 
# merge_rasters = function(fi){
#   raster_list = vector("list", length = 12)
#   for (i in 1:12){
#     raster_list[[i]] = purrr::map2(fi, i, \(x, i) x$path[i]) |>
#       purrr::map(rast) |>
#       sprc() |>
#       mosaic()
#   }
...
# }
# 
# r = merge_rasters(s2_reg$file_info)
...
# 
# plotRGB(rp[[2:4]], stretch = "lin", r = 3, g = 2, b = 1)
# 
...
# plotRGB(ps, stretch = "lin", r = 3, g = 2, b = 1)
# 
# ps2 = stretch(rp, minq = 0.1, maxq = 0.95)
