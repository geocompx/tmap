...
To demonstrate the positioning of map components, we will use a simple map with the elevation raster data of Slovenia in meters above sea level (*m asl*) (not shown).
