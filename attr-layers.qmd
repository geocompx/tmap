...
Attribute layers are map components that are not directly related to the data-driven map layers while providing additional information or context to the map.
They are not tied to the map's coordinates but rather to the map's layout and design.
@tbl-attr-layers-table shows the list of available attribute layers in **tmap**.
...
#| fig-cap: "Attribute layers in **tmap**."
#| echo: false
#| warning: false
