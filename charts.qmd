...
tm_shape(slo_regions) +
  tm_polygons(fill = "region_group",
              fill.chart = tm_chart_bar(position = tm_pos_out("center", "bottom", 0.15, 1)),
              fill.legend = tm_legend(position = tm_pos_out("center", "bottom", 0, 1))) +
  tm_polygons(fill = "region_group",
              fill.chart = tm_chart_donut(position = tm_pos_out("center", "bottom", 0.75, 1)),
              fill.legend = tm_legend(position = tm_pos_out("center", "bottom", 0.6, 1)))
```
