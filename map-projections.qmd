...
Then, we can also set the `bg.color` argument to specify the background color of the map, which will only apply to the area inside the Earth's boundary for a given projection (@ @fig-mproj3).
